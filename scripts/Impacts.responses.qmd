...
summary(linearMod_1997)
both_nonsig(RecLicenseCoast, RecLicenseCoast$number, intercept_RecLicenseCoast, pdata_RecLicenseCoast, mod.dsig_RecLicenseCoast, "Number", "Year", "Number of CRFL Licenses Purchased in Coastal Counties") + theme(plot.margin = margin(1,0.75,1,0.75, "cm"))
...
summary(linearMod_1997)
both_sig(RecLicenseNonCoast, RecLicenseNonCoast$number, intercept_RecLicenseNonCoast, pdata_RecLicenseNonCoast, mod.dsig_RecLicenseNonCoast, dfpost1997_RecLicenseNonCoast, dfpost1997_RecLicenseNonCoast$number, "Number", "Year", "Number of CRFL Licenses Purchased in Non-coastal Counties") + theme(plot.margin = margin(1,0.75,1,0.75, "cm"))
...
summary(linearMod_1997)
both_nonsig(RecLicenseInState, RecLicenseInState$number, intercept_RecLicenseInState, pdata_RecLicenseInState, mod.dsig_RecLicenseInState, "Number", "Year", "Number of CRFL Licenses Purchased in NC Counties") + theme(plot.margin = margin(1,0.75,1,0.75, "cm"))
