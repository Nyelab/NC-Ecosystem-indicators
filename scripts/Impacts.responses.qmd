...
VesselsNum <- read.csv("/users/sallydowd/Desktop/vessel_nums.csv")
...
summary(linearMod_1997)
both_sig(VesselsNum, VesselsNum$num_reg, intercept_VesselsNum, pdata_VesselsNum, mod.dsig_VesselsNum, dfpost1997_VesselsNum, dfpost1997_VesselsNum$num_reg, "Number Registered", "Year", "Number of Recreational Vessels Registered in NC") + theme(plot.margin = margin(1,0.75,1,0.75, "cm"))
