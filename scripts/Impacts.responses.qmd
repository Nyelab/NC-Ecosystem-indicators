...
VesselsNum <- read.csv("/users/sallydowd/Desktop/vessel_nums2.csv")
...
##VesselsNum
gam_diagn(VesselsNum$num_reg, 5, VesselsNum)
mod_VesselsNum <- gam(num_reg ~ s(year, k= 5), data = VesselsNum)
...
summary(linearMod_1997)
both_nonsig(VesselsNum, VesselsNum$num_reg, intercept_VesselsNum, pdata_VesselsNum, mod.dsig_VesselsNum, "Number Registered", "Year", "Number of Recreational Vessels Registered in NC") + theme(plot.margin = margin(1,0.75,1,0.75, "cm"))
